        ...
        case "$CertBotDomains" in
          ...
          * )
            ...
            # Generate test certificate
              ...
              certbot certonly --webroot -w /usr/share/nginx/html -d "${!DomainVar}" --email "$LE_EMAIL" --agree-tos --non-interactive --keep-until-expiring --rsa-key-size 4096 --hsts --uir --preferred-challenges http --test-cert
